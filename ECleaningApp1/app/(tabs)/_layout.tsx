...
export default function TabLayout() {
  return (
    <Tabs screenOptions={{ tabBarActiveTintColor: '#2E86DE' }}>
      ...
      <Tabs.Screen name="status" options={{ title: 'Status', tabBarIcon: ({ color, size }) => <FontAwesome name="signal" size={size} color={color} /> }} />
